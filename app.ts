...
//@ts-ignore
app.use('/api/user', middleware.AuthMiddleware, userRouter)
//@ts-ignore
app.use('/api/action', middleware.AuthMiddleware, actionRouter)
//@ts-ignore
app.use('/api/message', middleware.AuthMiddleware, messageRouter)
